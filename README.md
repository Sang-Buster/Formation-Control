...
**PS**: In order to run `src/Swarm_Formation_of_8_After.m`, it is required to have Matlab-based modeling system for convex optimization (CVX)! [Download CVX Here](http://cvxr.com/cvx/).
